# Generated by Django 5.2 on 2025-08-11 04:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization_name', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='compensation_payroll.organizationalprofile')),
                ('original_payroll_record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='earning_adjustments', to='compensation_payroll.regularpayroll')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateField(default=datetime.date.today, help_text='Date when this record was last updated')),
                ('organization_name', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='compensation_payroll.organizationalprofile')),
                ('original_payroll_record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='deduction_adjustments', to='compensation_payroll.regularpayroll')),
                ('payroll_needing_adjustment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='compensation_payroll.regularpayroll')),
            ],
        ),
        migrations.CreateModel(
