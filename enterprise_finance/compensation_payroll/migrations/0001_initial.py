# Generated by Django 5.2 on 2025-08-07 07:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('record_month', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='earning_adjustments', to='compensation_payroll.regularpayroll')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization_name', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='compensation_payroll.organizationalprofile')),
                ('payroll_needing_adjustment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='compensation_payroll.regularpayroll')),
                ('record_month', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='deduction_adjustments', to='compensation_payroll.regularpayroll')),
            ],
        ),
        migrations.CreateModel(
            name='SeverancePay',
