"""
Django settings for enterprise_finance project.
...
SECRET_KEY = 'django-insecure-y_bw59s!h8sllucc@+la1vbgg2)7o9j+rns&3t8ibv5-d(qh!s'
...
ROOT_URLCONF = 'enterprise_finance.urls'
...
WSGI_APPLICATION = 'enterprise_finance.wsgi.application'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    BASE_DIR / 'compensation_payroll' / 'static',
...
# EMAIL_PORT = 587  # TLS
# EMAIL_USE_TLS = True
# EMAIL_HOST_USER = 'sisaymineto@gmail.com'  # Your Gmail address
# EMAIL_HOST_PASSWORD = 'dgqeqghwjuzzwfgy'  # Your Gmail password or App Password
...
LOGIN_URL = 'login'
LOGOUT_URL = 'logout'
LOGIN_REDIRECT_URL = '/compensation-payroll/'
...
# settings.py
SESSION_COOKIE_NAME = 'payroll_sessionid'  # Unique name
