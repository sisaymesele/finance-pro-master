# Generated by Django 5.2 on 2025-08-06 08:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization_name', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='compensation_payroll.organizationalprofile')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('regular_employment_income_tax', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('regular_employee_pension_contribution', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('regular_employer_pension_contribution', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('regular_total_pension', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('regular_gross_pay', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('regular_gross_non_taxable_pay', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('regular_gross_taxable_pay', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('regular_total_payroll_deduction', models.DecimalField(blank=True, decimal_places=2, max_digits=12, null=True)),
                ('regular_net_pay', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('regular_expense', models.DecimalField(blank=True, decimal_places=2, max_digits=20, null=True)),
                ...
                ('organization_name', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='compensation_payroll.organizationalprofile')),
                ('payroll_month', models.ForeignKey(help_text='Payroll processing month', null=True, on_delete=django.db.models.deletion.SET_NULL, to='compensation_payroll.payrollmonthcomponent')),
                ('personnel_full_name', models.ForeignKey(help_text='Please select personnel full name', null=True, on_delete=django.db.models.deletion.SET_NULL, to='compensation_payroll.personnellist')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recorded_month_adjusted_employee_pension_contribution', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('recorded_month_adjusted_employer_pension_contribution', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('recorded_month_adjusted_total_pension', models.DecimalField(blank=True, decimal_places=2, max_digits=15, null=True)),
                ('recorded_month_adjusted_taxable_gross_pay', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=12)),
                ('recorded_month_adjusted_non_taxable_gross_pay', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=12)),
                ('recorded_month_adjusted_gross_pay', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=12)),
                ...
                ('recorded_month_employment_income_tax_on_adjustment', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=12)),
                ('recorded_month_earning_adjustment_deduction_total', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=12)),
                ('recorded_month_adjusted_expense', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=12)),
                ...
                ('organization_name', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='compensation_payroll.organizationalprofile')),
                ('payroll_needing_adjustment', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='compensation_payroll.regularpayroll')),
                ('record_month', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='earning_adjustments', to='compensation_payroll.regularpayroll')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adjusted_deduction_per_adjusted_month', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=12, validators=[django.core.validators.MinValueValidator(Decimal('0.00'))])),
                ('monthly_adjusted_deduction', models.DecimalField(decimal_places=2, default=Decimal('0.00'), max_digits=12, validators=[django.core.validators.MinValueValidator(Decimal('0.00'))])),
                ('period_start', models.DateField(default=datetime.date.today)),
                ('period_end', models.DateField(default=datetime.date.today)),
                ('months_covered', models.IntegerField()),
                ('created_at', models.DateField(blank=True, default=datetime.date.today, help_text='Date when this record was created')),
                ...
                ('organization_name', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='compensation_payroll.organizationalprofile')),
                ('payroll_needing_adjustment', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='compensation_payroll.regularpayroll')),
                ('record_month', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='deduction_adjustments', to='compensation_payroll.regularpayroll')),
            ],
        ),
        migrations.CreateModel(
            name='SeverancePay',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('year', models.CharField(choices=[('2017', '2017'), ('2018', '2018'), ('2019', '2019'), ('2020', '2020'), ('2021', '2021'), ('2022', '2022'), ('2023', '2023'), ('2024', '2024'), ('2025', '2025'), ('2026', '2026'), ('2027', '2027'), ('2028', '2028'), ('2029', '2029'), ('2030', '2030'), ('2031', '2031'), ('2032', '2032'), ('2033', '2033'), ('2034', '2034'), ('2035', '2035'), ('2036', '2036'), ('2037', '2037'), ('2038', '2038'), ('2039', '2039'), ('2040', '2040')], default='2025', help_text='Severance processing year', max_length=4)),
                ('month', models.CharField(choices=[('01', 'September'), ('02', 'October'), ('03', 'November'), ('04', 'December'), ('05', 'January'), ('06', 'February'), ('07', 'March'), ('08', 'April'), ('09', 'May'), ('10', 'June'), ('11', 'July'), ('12', 'August')], default='August', help_text='Severance processing month', max_length=12)),
